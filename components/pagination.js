export default{
    ...
    <ul class="pagination">
      <li class="page-item " :class="paginationjs.has_pre ? 'enabled':'disabled'">
        <a class="page-link" href="" aria-label="Previous" @click.prevent="pageTrans(pagepre=currpagejs-1)">
      ...
      <li class="page-item" v-bind:class="paginationjs.has_next ? 'enabled':'disabled'">
        <a class="page-link" href="" aria-label="Next" @click.prevent="pageTrans(pagenxt=currpagejs+1)">
